//(1)퍼즐 맵의 크기 확장(5x5)[TwentyFourPuzzle.cpp]
#include "Ranking.h"
...
static void shuffle(int nShuffle) {      //퍼즐 섞기
...
static int getDirKey() { return _getche() == 224 ? _getche() : 0; }    //방향키 입력
